...
import { IShipmentInbound } from '../PrintDownloadButtons/types';
import { getSteps } from '../helpers';
import LogoWhite from '@/shared/assets/images/Desktop/Reviews/EnVersion/Review1_Desktop.png';
...
const PDFDocumentInboundShipment: FC = () => {
  ...
  const { description, location, numberOfCards } = inboundShipment;
        ...
        <div className='pdf-container__title'>
          <div className='pdf-container__title__left'>
            ...
            <div>
              ...
              {'cards get to'}{' '}
              <strong>{'us safety and ready for processing'}</strong>
        ...
        <div className='pdf-container__stepper'>
          ...
          <div className='pdf-container__stepper__shipment-details'>
            <div className='pdf-container__stepper__shipment-details__title'>
              <img src={LogoWhite} alt='smallbox' loading='lazy' />
            ...
            <div className='pdf-container__stepper__shipment-details__title'>
              <img src={LogoWhite} alt='Location' loading='lazy' />
              <div className='pdf-container__stepper__shipment-details__title__text'>
                {'Ship to address'}
              </div>
            </div>
