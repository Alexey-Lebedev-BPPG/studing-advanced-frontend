...
import AddPhotoSVG from '@/shared/assets/icons/Info.svg';
import AvatarSVG from '@/shared/assets/icons/about-20-20.svg';
import BasketSVG from '@/shared/assets/icons/app-image.svg';
...
export const AvatarForProfileWithChangePhoto: FC<IAvatarForProfileWithChangePhotoProps> =
  memo(({ isChanges, isLoading, photo }) => {
