...
// в скриптах есть updateImports, который позволяет быстро добавить алиасы в абсолютные пути в проекте. запускается командой npx ts-node ./scripts/updateImports.ts
